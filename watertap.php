        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="watertap.php" class="nav-item nav-link active"><i class="fas fa-tint me-2"></i>Water Tap</a>
                            ...
                            <div class="d-flex justify-content-between">
                                <div>
                                    <div class="centered-element">
                                        ...
                                        <p class="mb-0" id="sts-tteras">Loading...</p>
                                    </div>                                    
                                </div>
            
                                <div class="squaresm shadow-sm text-center" style="cursor: pointer;" onclick="globalUpdate('kran1');">
                                    <div class="centered-element">
                                        <i class="fas fa-tint-slash lampico" id="ic-tteras"></i>                                        
                                    </div>                                    
                                </div>
                            </div>                            
                        </div>
                            ...
                            <div class="d-flex justify-content-between">
                                <div>
                                    <div class="centered-element">
                                        ...
                                        <p class="mb-0" id="sts-tgantung">Loading...</p>
                                    </div>                                    
                                </div>
            
                                <div class="squaresm shadow-sm text-center" style="cursor: pointer;" onclick="globalUpdate('kran2');">
                                    <div class="centered-element">
                                        <i class="fas fa-tint-slash lampico" id="ic-tgantung"></i>
                                    </div>
                                </div>
                            </div>                           
                        </div>
                            ...
                            <div class="d-flex justify-content-between">
                                <div>
                                    <div class="centered-element">
                                        ...
                                        <p class="mb-0" id="sts-tsamping">Loading...</p>
                                    </div>                                    
                                </div>
            
                                <div class="squaresm shadow-sm text-center" style="cursor: pointer;" onclick="globalUpdate('kran3');">
                                    <div class="centered-element">
                                        <i class="fas fa-tint-slash lampico" id="ic-tsamping"></i>
                                    </div>
                                </div>
                            </div> 
                        </div>
